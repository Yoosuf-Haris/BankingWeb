...
<html lang="en">
    <head>
        ...
        <title>Users - Banking system </title>
						...
						<div class="col-sm-6 col-md-3"> 
							<div class="form-group form-focus select-focus">
								<select class="select floating"> 
									...
									<option>Sri lanka savings bank</option>
						...
						<div class="col-sm-6 col-md-3"> 
							<div class="form-group form-focus select-focus">
								<select class="select floating"> 
									...
									<option>Local accounts creator</option>
									<option>Trainee</option>
									<option>Foreign accounts creator</option>
									<option>Savings manager</option>
								</select>
