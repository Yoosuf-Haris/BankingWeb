								...
								<table class="table table-striped custom-table mb-0 datatable">
									...
									<tbody>
										<tr>
											...
											<td>Efficient work hours tracking system.</td>
											<td>
										...
										<tr>
											<td>2</td>
											<td>Fraud Detection and Prevention Training</td>
											<td>Efficient work hours tracking system.</td>
											<td>
												<div class="dropdown action-label">
													<a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
										...
										<tr>
											<td>4</td>
											<td>Digital Banking Training</td>
											<td>Efficient work hours tracking system.</td>
											<td>
												<div class="dropdown action-label">
													<a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
										...
										<tr>
											<td>5</td>
											<td>Loan and Mortgage Processing Training</td>
											<td>Efficient work hours tracking system.</td>
											<td>
												<div class="dropdown action-label">
													<a class="btn btn-white btn-sm btn-rounded dropdown-toggle" href="#" data-toggle="dropdown" aria-expanded="false">
