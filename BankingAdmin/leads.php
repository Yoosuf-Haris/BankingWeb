...
<html lang="en">
    <head>
        ...
        <title>Leads - Banking system </title>
								...
								<table class="table table-striped table-nowrap custom-table mb-0 datatable">
									...
									<tbody>
										<tr>
											...
											<td>9876543210</td>
											<td><a href="project-view.php">Customer Relationship Management</a></td>
											<td>
										...
										<tr>
											...
											<td>9876543210</td>
											<td><a href="project-view.php">Loan Application and Processing</a></td>
											<td>
												<ul class="team-members">
													<li>
														<a href="#" title="John Doe" data-toggle="tooltip"><img alt="" src="assets/img/profiles/avatar-02.jpg"></a>
    ...
    <td>9876543211</td>
    <td><a href="project-view.php">Healthcare Portal</a></td>
											<td>
												<ul class="team-members">
													<li>
														<a href="#" title="John Doe" data-toggle="tooltip"><img alt="" src="assets/img/profiles/avatar-02.jpg"></a>
    ...
    <td>1234567890</td>
    <td><a href="project-view.php">Finance Management</a></td>
											<td>
												<ul class="team-members">
													<li>
														<a href="#" title="John Doe" data-toggle="tooltip"><img alt="" src="assets/img/profiles/avatar-02.jpg"></a>
										...
										<tr>
											...
											<td>alicewong@example.com</td>
    <td>5432167890</td>
    <td><a href="project-view.php">E-commerce System</a></td>
											<td>
												<ul class="team-members">
													<li>
														<a href="#" title="John Doe" data-toggle="tooltip"><img alt="" src="assets/img/profiles/avatar-02.jpg"></a>
										...
										<tr>
											...
											<td>caroldiaz@example.com</td>
    <td>7654321980</td>
    <td><a href="project-view.php">Social Media App</a></td>
											<td>
												<ul class="team-members">
													<li>
														<a href="#" title="John Doe" data-toggle="tooltip"><img alt="" src="assets/img/profiles/avatar-02.jpg"></a>
										...
										<tr>
											...
											<td>evagarcia@example.com</td>
    <td>9876543120</td>
    <td><a href="project-view.php">Bank Account Management</a></td>
											<td>
												<ul class="team-members">
													<li>
														<a href="#" title="John Doe" data-toggle="tooltip"><img alt="" src="assets/img/profiles/avatar-02.jpg"></a>
										...
										<tr>
											...
											<td>franklinjones@example.com</td>
    <td>3456789012</td>
    <td><a href="project-view.php">Analytics Dashboard</a></td>
											<td>
												<ul class="team-members">
													<li>
														<a href="#" title="John Doe" data-toggle="tooltip"><img alt="" src="assets/img/profiles/avatar-02.jpg"></a>
										...
										<tr>
											...
											<td>ginabrown@example.com</td>
    <td>4567890123</td>
    <td><a href="project-view.php">Time Tracking System</a></td>
											<td>
												<ul class="team-members">
													<li>
														<a href="#" title="John Doe" data-toggle="tooltip"><img alt="" src="assets/img/profiles/avatar-02.jpg"></a>
