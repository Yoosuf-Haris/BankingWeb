...
<html lang="en">
    ...
    <td>8 Mar 2019</td>
    <td><h2>Office Management</h2></td>
    <td class="text-center">20</td>
    <td class="text-center">7</td>
    <td class="d-none d-sm-table-cell col-md-4">Experience the elegance of simplicity, designed to bring out the best in every moment.</td><td class="text-right">
        ...
        <h2 class="table-avatar">
            ...
            <a href="profile.php">Richard Miles <span>Financial Analyst</span></a>
        </h2>
    </td>
    <td>8 Mar 2019</td>
    <td><h2>Bank Account Management</h2></td>
    <td class="text-center">20</td>
    <td class="text-center">12</td>
    <td class="d-none d-sm-table-cell col-md-4">Experience the elegance of simplicity, designed to bring out the best in every moment.</td>
<td class="text-right">
												<div class="dropdown dropdown-action">
													<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
													<div class="dropdown-menu dropdown-menu-right">
    ...
    <td>8 Mar 2019</td>
    <td><h2>Loan Application and Processing</h2></td>
    <td class="text-center">20</td>
    <td class="text-center">12</td>
    <td class="d-none d-sm-table-cell col-md-4">Experience the elegance of simplicity, designed to bring out the best in every moment.</td>
<td class="text-right">
    ...
    <td>8 Mar 2019</td>
    <td><h2>Customer Relationship Management</h2></td>
    <td class="text-center">20</td>
    <td class="text-center">12</td>
    <td class="d-none d-sm-table-cell col-md-4">Experience the elegance of simplicity, designed to bring out the best in every moment.</td>
<td class="text-right">
...
<td class="text-right">
        ...
        <h2 class="table-avatar">
            ...
            <a href="profile.php">Jeffrey Warden <span>Financial Analyst</span></a>
        </h2>
    </td>
    <td>8 Mar 2019</td>
    <td><h2>Bank Account Management</h2></td>
...
<td class="text-right">
        ...
        <h2 class="table-avatar">
            ...
            <a href="profile.php">Bernardo Galaviz <span>Financial Analyst</span></a>
        </h2>
    </td>
    <td>8 Mar 2019</td>
    <td><h2>Loan Application and Processing</h2></td>
