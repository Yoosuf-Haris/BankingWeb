...
<html lang="en">
    <head>
        ...
        <title>Roles & Permission - Banking system </title>
						...
						<div class="col-sm-4 col-md-4 col-lg-4 col-xl-3">
							...
							<div class="roles-menu">
								<ul>
									...
									<li>
										<a href="javascript:void(0);">Financial Analyst
											<span class="role-action">
												<span class="action-circle large" data-toggle="modal" data-target="#edit_role">
													<i class="material-icons">edit</i>
												</span>
									...
									<li>
										<a href="javascript:void(0);">Savings Manager
											<span class="role-action">
												<span class="action-circle large" data-toggle="modal" data-target="#edit_role">
													<i class="material-icons">edit</i>
												</span>
									...
									<li>
										<a href="javascript:void(0);">Bank Account Creator
											<span class="role-action">
												<span class="action-circle large" data-toggle="modal" data-target="#edit_role">
													<i class="material-icons">edit</i>
												</span>
