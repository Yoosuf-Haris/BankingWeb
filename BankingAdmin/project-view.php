...
<html lang="en">
    <head>
        ...
        <title>Project View - Banking system </title>
											...
											<a href="profile.php">
												<div class="list-item">
													...
													<div class="list-body">
														...
														<div class="clearfix"></div>
														<span class="message-content">Financial Analyst</span>
													</div>
												</div>
											</a>
										</li>
									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												...
												<input class="form-control" value="Bank Account Management" type="text">
											</div>
										</div>
										<div class="col-sm-6">
											<div class="form-group">
