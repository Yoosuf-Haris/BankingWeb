									...
									<div class="row">
										<div class="col-sm-6">
											<div class="form-group">
												...
												<select class="select">
													<option selected="">Customer Relationship Management</option>
													<option>Compliance and Regulatory Training</option>
													<option>Fraud Detection and Prevention Training</option>
												</select>
											</div>
										</div>
										<div class="col-sm-6">
										...
										<div class="col-sm-12">
											<div class="form-group">
												...
												<textarea class="form-control" rows="4">LEfficient work hours tracking system.</textarea>
											</div>
										</div>
										<div class="col-sm-12">
											<div class="form-group">
