									...
									<div class="row">
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<input class="form-control" type="text" value="Efficient work hours tracking system.">
											</div>
										</div>
										...
										<div class="col-sm-12">
											<div class="form-group">
												...
												<textarea class="form-control" rows="4">Efficient work hours tracking system.</textarea>
											</div>
										</div>
										<div class="col-sm-12">
											<div class="form-group">
