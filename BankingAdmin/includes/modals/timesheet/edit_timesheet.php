							...
							<div class="modal-body">
								<form>
									<div class="row">
										<div class="form-group col-sm-6">
											...
											<select class="select">
												...
												<option>Bank Account Management</option>
												<option>Loan Application and Processing</option>
									...
									<div class="form-group">
										...
										<textarea rows="4" class="form-control">Experience the elegance of simplicity, designed to bring out the best in every moment.</textarea>
									</div>
