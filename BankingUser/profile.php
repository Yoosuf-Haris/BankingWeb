...
<html lang="en">
    ...
    <body>
								...
								<div class="col-md-12">
									<div class="profile-view">
										<div class="profile-img-wrap">
											...
											<a href="#"><img alt="" src="profiles/Fathi.jpg"></a>
											</div>
										</div>
        ...
        <h3 class="user-name m-t-0 mb-0">Fathima Nifla</h3>
        <h6 class="text-muted">Banking Operations Team</h6>
        <small class="text-muted">Relationship Manager</small>
        <div class="staff-id">Employee ID : BK-0001</div>
        <div class="small doj text-muted">Date of Joining : 1st Jan 2015</div>
												...
												<div class="col-md-7">
													<ul class="personal-info">
														<li>
															...
															<div class="text"><a href="">+94772580782</a></div>
														</li>
														<li>
															<div class="title">Email:</div>
															<div class="text"><a href="">fathima@example.com</a></div>
														</li>
														<li>
															<div class="title">Birthday:</div>
															<div class="text">07th September</div>
														</li>
														<li>
															<div class="title">Address:</div>
															<div class="text">296/A, Infront of the temple rd, Bamunwala, Kurunegala, Sri Lanka</div>
														</li>
														<li>
						...
						<div class="row user-tabs">
							<div class="col-lg-12 col-md-12 col-sm-12 line-tabs">
								<ul class="nav nav-tabs nav-tabs-bottom">
									<li class="nav-item"><a href="#emp_profile" data-toggle="tab" class="nav-link active">Profile<small class="text-danger">(Admin Only)</small></a></li>
								</ul>
							</div>
						</div>
					</div>
										...
										<div class="card-body">
											...
											<ul class="personal-info">
												<li>
													...
													<div class="text">0276543210</div>
												</li>
												<li>
													<div class="title">Passport Exp Date.</div>
													<div class="text">05/05/2025</div>
												</li>
												<li>
													<div class="title">Tel</div>
													<div class="text"><a href="">+94778953210</a></div>
												</li>
												<li>
									...
									<div class="card profile-box flex-fill">
										<div class="card-body">
											...
											<ul class="personal-info">
												...
												<li>
													<div class="title">Phone </div>
													<div class="text">+94776543210, +94776543210</div>
												</li>
											</ul>
											<hr>
											...
											<ul class="personal-info">
												...
												<li>
													<div class="title">Phone </div>
													<div class="text">+94776548510, +94776543210</div>
												</li>
											</ul>
										</div>
									</div>
										...
										<div class="card-body">
											...
											<ul class="personal-info">
												<li>
													...
													<div class="text">Sri lanka savings bank</div>
												</li>
												<li>
                        ...
                        <li>
                            ...
                            <div class="experience-content">
                                <div class="timeline-content">
                                    ...
                                    <span class="time">Jan 2018 - Jan 2021 (3 years)</span>
                                </div>
                            </div>
                        </li>
                        <li>
